...
@Repository
public class SavingTransactionDaoImpl extends JdbcDaoSupport implements SavingTransactionDao {
	...
	private class TransactionsByAcctIdQuery extends BaseQuery {
		public TransactionsByAcctIdQuery(DataSource ds) {
			super(ds, "select a.trans_id, a.acct_id, a.trans_date, a.description, a.trans_amt, " +
					"a.trans_acct, b.acct_name as xfer_acct " +
					"FROM sav_trans a " +
	...
	private class TransactionsByAcctNameQuery extends BaseQuery {
		public TransactionsByAcctNameQuery(DataSource ds) {
			super(ds, "select a.trans_id, a.acct_id, a.trans_date, a.description, a.trans_amt, " +
					"a.trans_acct, c.acct_name as xfer_acct " +
					"FROM sav_trans a " +
	...
	private class Insert extends SqlUpdate {
		private static final String SQL = "insert into sav_trans (acct_id, trans_date, description, trans_amt, trans_acct) "
	...
	private class Delete extends SqlUpdate {
		private static final String SQL = "delete from sav_trans where trans_id = :transId";
